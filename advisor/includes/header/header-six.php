 ...
 */
 ...
 <!-- HERDER -->
 <header id="header" class="header-six header-six-wrapper" <?php if ( !empty ( $menu_background_color ) ) { ?>style="background:<?php echo esc_attr( $menu_background_color ); ?>" <?php } ?>>
   <div class="container-fluid">
     <!-- HEADER INNER -->
     <div class="header clearfix">

      <strong class="ad-logo ad-light">
       ...
       <!-- <strong class="ad-logo ad-dark"><a href="#"><img src="images/logo.png" alt="image description"></a></strong> -->
       <?php if ( !empty( $get_quote_url ) && !empty( $get_quote_label )  ) { ?><a href="<?php echo esc_url( $get_quote_url ); ?>" class="btn btn-primary btn-quote" data-text="<?php echo esc_attr( $get_quote_label ); ?>"><?php echo esc_html( $get_quote_label ); ?></a><?php } ?>
       <div class="ad-navigationarea">
         <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#ad-navigationsix" aria-expanded="false">
           <span class="sr-only">Toggle navigation</span>
           <span class="icon-bar"></span>
           <span class="icon-bar"></span>
           <span class="icon-bar"></span>
         </button>
         <ul class="header-links clearfix color_red">
         ...
         <nav class="main-nav navbar-collapse collapse ad-navigationsix" id="ad-navigationsix">
           <!-- Add Main menu -->
