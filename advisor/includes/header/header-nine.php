 ...
 */
 ...
 <header id="header" class="header-seven header-nine">
   <div class="container">
     <!-- HEADER INNER -->
     <div class="header clearfix">
       ...
       <div class="ad-topbar">
         ...
         <ul class="header-links">
          ...
          <?php if( !empty( $header_office ) || !empty( $working_days ) ) { ?>
            <li class="header-time"><i class="icon-icons20"></i>
              <?php if( !empty( $header_office ) ) { ?><?php echo $header_office; ?><?php } ?>
              <?php if( !empty( $working_days ) ) { ?><?php echo  $working_days; ?><?php } ?>
            </li>
          <?php } ?>
       ...
       <div class="ad-navigationbox">
         ...
         <div class="ad-navigationarea">
           <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#ad-navigationseven" aria-expanded="false">
           ...
           <nav class="main-nav navbar-collapse collapse ad-navigationseven" id="ad-navigationseven">
             <!-- Add Main menu -->
